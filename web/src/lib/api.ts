...
import type { RacingAnalysisSetting, RacingAnalysisHistory, RacingReclaimPolicy, RacingReclaimConfiguration, RacingInstancePolicy, RacingAddIntents, RacingCandidates, RacingDiscoveries, RacingConfiguration, RacingObservations, RacingResource, RacingResourceInput } from "@/types/racing"
...
class ApiClient {
  ...
  getRacingAnalysisSettings() { return this.request<RacingAnalysisSetting[]>("/racing/analysis-settings") }
  saveRacingAnalysisSetting(setting: RacingAnalysisSetting) { return this.request<void>(`/racing/analysis-settings/${setting.instanceId}`, { method: "PUT", body: JSON.stringify(setting) }) }
  getRacingAnalysisHistory(key: string) { return this.request<RacingAnalysisHistory>(`/racing/analysis-history?candidateKey=${encodeURIComponent(key)}`) }
