    ...
    onMutate: async (newData) => {
      ...
      if (previousSettings) {
        queryClient.setQueryData<DashboardSettings>(QUERY_KEY, {
          ...
          serverStatsSortColumn: newData.serverStatsSortColumn ?? previousSettings.serverStatsSortColumn,
          serverStatsSortDirection: newData.serverStatsSortDirection ?? previousSettings.serverStatsSortDirection,
