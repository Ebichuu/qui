...
CREATE TABLE racing_instance_policies (
    ...
    max_concurrent_adds BIGINT NOT NULL,
    max_active_downloads BIGINT NOT NULL,
    min_free_bytes BIGINT NOT NULL,
    save_path TEXT NOT NULL DEFAULT '',
    category TEXT NOT NULL DEFAULT '',
    auto_tmm BIGINT NOT NULL DEFAULT 0,
    start_paused BIGINT NOT NULL DEFAULT 0,
