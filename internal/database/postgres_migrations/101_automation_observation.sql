...
CREATE TABLE automation_condition_observations (
...
CREATE INDEX idx_automation_observation_rule ON automation_condition_observations(rule_id);
CREATE TABLE automation_delete_cooldowns (
